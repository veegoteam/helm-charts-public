# home-score-devices-data-handler
...
| configMap.VEEGO_KAFKA_CONSUMER_GROUP_ID | string | `"home-score-devices-data-handler"` |  |
...
| image.repository | string | `"veego/home-score-devices-data-handler"` |  |
