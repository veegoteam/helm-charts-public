# doxi-veego-service-status-handler
...
| configMap.VEEGO_KAFKA_CONSUMER_GROUP_ID | string | `"doxi-veego-service-status-main"` |  |
...
| image.repository | string | `"veego/doxi-veego-service-status-handler"` |  |
