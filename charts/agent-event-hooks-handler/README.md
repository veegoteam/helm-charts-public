...
| configMap.VEEGO_KAFKA_CONSUMER_GROUP_ID | string | `"agent-event-hooks-main"` |  |
| configMap.VEEGO_KAFKA_HOSTS | string | `""` |  |
| configMap.VEEGO_KAFKA_TOPIC | string | `"agent_event_hooks"` |  |
...
| image.repository | string | `"veego/agent-event-hooks-handler"` |  |
