...
| configMap.VEEGO_KAFKA_CONSUMER_GROUP_ID | string | `"telemetry-handler"` |  |
| configMap.VEEGO_KAFKA_DEVICE_COLLECTOR_TOPIC | string | `"device_collector"` |  |
...
| image.repository | string | `"veego/telemetry-handler"` |  |
