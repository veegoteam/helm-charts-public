...
| configMap.VEEGO_KAFKA_CONSUMER_GROUP_ID | string | `"doxi-veego-devices-main"` |  |
| configMap.VEEGO_KAFKA_DOXI_VEEGO_DEVICES_TOPIC | string | `"doxi_veego_devices"` |  |
...
| image.repository | string | `"veego/doxi-veego-devices-handler"` |  |
