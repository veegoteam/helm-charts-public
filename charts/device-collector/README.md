...
| configMap.VEEGO_KAFKA_CONSUMER_GROUP_ID | string | `"device_collector"` |  |
| configMap.VEEGO_KAFKA_HOSTS | string | `""` |  |
| configMap.VEEGO_KAFKA_TOPIC | string | `"device_collector"` |  |
...
| image.repository | string | `"veego/device-collector"` |  |
