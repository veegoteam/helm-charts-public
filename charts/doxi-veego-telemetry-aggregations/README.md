# doxi-veego-telemetry-aggregations
...
| configMap.VEEGO_KAFKA_DOXI_VEEGO_TELEMETRY_AGGREGATIONS_TOPIC | string | `"doxi_veego_telemetry_aggregations"` |  |
...
| image.repository | string | `"veego/doxi-veego-telemetry-aggregations"` |  |
