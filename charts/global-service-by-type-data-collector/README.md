# global-service-by-type-data-collector
...
| configMap.VEEGO_KAFKA_CONSUMER_GROUP_ID | string | `"global-service-by-type-data-collector-main"` |  |
...
| image.repository | string | `"veego/global-service-by-type-data-collector"` |  |
