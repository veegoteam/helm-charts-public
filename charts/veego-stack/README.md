...
| agent-disconnect-detector.image.tag | string | `"dev"` |  |
...
| agent-event-hooks-handler.image.tag | string | `"dev"` |  |
...
| agent-registration-handler.image.tag | string | `"dev"` |  |
...
| agent-statistics-handler.image.tag | string | `"dev"` |  |
...
| agents-dispatcher.image.tag | string | `"dev"` |  |
...
| aggregated-telemetry-handler.image.tag | string | `"dev"` |  |
...
| aggregation-ignitor.image.tag | string | `"dev"` |  |
...
| api-gateway.image.tag | string | `"dev"` |  |
...
| charter-veego-agents-handler.image.tag | string | `"dev"` |  |
...
| command-result-handler.image.tag | string | `"dev"` |  |
...
| command-topic-creator.image.tag | string | `"dev"` |  |
...
| device-collector.image.tag | string | `"dev"` |  |
...
| device-uptime-handler.image.tag | string | `"dev"` |  |
...
| domain-json.image.tag | string | `"dev"` |  |
...
| doxi-veego-agents-disconnect-detector.image.tag | string | `"dev"` |  |
...
| doxi-veego-agents-handler.image.tag | string | `"dev"` |  |
...
| doxi-veego-devices-handler.image.tag | string | `"dev"` |  |
...
| doxi-veego-notifications-handler.image.tag | string | `"dev"` |  |
...
| doxi-veego-service-status-handler.image.tag | string | `"dev"` |  |
...
| doxi-veego-service-usages.image.tag | string | `"dev"` |  |
...
| doxi-veego-services-handler.image.tag | string | `"dev"` |  |
...
| doxi-veego-telemetry-aggregations.image.tag | string | `"dev"` |  |
...
| global-service-by-type-data-collector.image.tag | string | `"dev"` |  |
...
| global-service-by-type-score-handler.image.tag | string | `"dev"` |  |
...
| home-score-devices-data-handler.image.tag | string | `"dev"` |  |
...
| malfunctions-counters-cleaner.image.tag | string | `"dev"` |  |
...
| mobile-api.image.tag | string | `"dev"` |  |
...
| monitor-connections.image.tag | string | `"dev"` |  |
...
| notifications-handler.image.tag | string | `"dev"` |  |
...
| notifications-telemetry-collector-ignitor.image.tag | string | `"dev"` |  |
...
| notifications-telemetry-collector.image.tag | string | `"dev"` |  |
...
| probe-notifications-telemetry-handler.image.tag | string | `"dev"` |  |
...
| probe-telemetry-handler.image.tag | string | `"dev"` |  |
...
| speedtest-handler.image.tag | string | `"dev"` |  |
...
| telemetry-aggregator.image.tag | string | `"dev"` |  |
...
| telemetry-handler.image.tag | string | `"dev"` |  |
...
| wifi-global-malfunctions-statistics-builder.image.tag | string | `"dev"` |  |
...
| wifi-malfunctions-counters-cleaner.image.tag | string | `"dev"` |  |
...
| wifi-malfunctions-data-collector.image.tag | string | `"dev"` |  |
...
| wifi-score-handler.image.tag | string | `"dev"` |  |
