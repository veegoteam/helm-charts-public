# doxi-veego-notifications-handler
...
| configMap.VEEGO_KAFKA_CONSUMER_GROUP_ID | string | `"doxi-veego-notifications-main"` |  |
| configMap.VEEGO_KAFKA_DOXI_VEEGO_NOTIFICATIONS_TOPIC | string | `"doxi_veego_notifications"` |  |
...
| image.repository | string | `"veego/doxi-veego-notifications-handler"` |  |
