...
|-----|------|---------|-------------|
| configMap.VEEGO_KAFKA_CONSUMER_GROUP_ID | string | `"command-result-main"` |  |
| configMap.VEEGO_KAFKA_TOPIC | string | `"command_result"` |  |
| extraConfigMap | list | `[]` |  |
| extraSecret | list | `[]` |  |
...
| image.repository | string | `"veego/command-result-handler"` |  |
